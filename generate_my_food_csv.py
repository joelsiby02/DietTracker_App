...
def generate_my_food_csv():
    ...
    my_foods = [
    # 🌾 Grains & Carbs
    {"name": "Kerala rice", "category": "Grains & Carbs", "unit": "100g cooked", "protein": 2.5, "carbs": 28, "fat": 0.3},
    {"name": "Whole wheat roti", "category": "Grains & Carbs", "unit": "1 roti (~50g)", "protein": 4, "carbs": 18, "fat": 1},
    {"name": "Oats (plain)", "category": "Grains & Carbs", "unit": "40g dry", "protein": 5.2, "carbs": 27, "fat": 2},

    # 🍲 Cooked Dishes
    {"name": "Soybean Symphony Biriyani", "category": "Cooked Dishes", "unit": "1 cup (~200g)", "protein": 18, "carbs": 45, "fat": 8},
    ...
    {"name": "Chapathi", "category": "Common Foods", "unit": "1 piece (~50g)", "protein": 4, "carbs": 18, "fat": 1},
    {"name": "Poori", "category": "Common Foods", "unit": "1 piece (~30g)", "protein": 2, "carbs": 15, "fat": 5},
    # 🥗 Custom Salad
    {"name": "Custom Fusion Salad", "category": "Salads", "unit": "1 serving (~150g)",
     "protein": 5, "carbs": 12, "fat": 1},
    ...
    {"name": "Whey protein scoop", "category": "Proteins", "unit": "1 scoop (~30g)", "protein": 24, "carbs": 3, "fat": 1.5},
